...
public class ClienteService {
    ...
    public Cliente addCliente(String usuario, String nome, String cpf, String rua, int numero, String bairro, String cep, String cidade){
        Endereco endereco = new Endereco(rua, numero, bairro, cep, cidade);
        endRep.save(endereco);
        Cliente cliente = new Cliente(usuario, nome, cpf, endereco);
